...
extension _SchoolShellPageSections on _SchoolShellPageState {
        ...
        children: <Widget>[
          Row(
            children: <Widget>[
              ...
              _summaryTile(
                'عدد الصلاحيات',
                (user?.permissions.length ?? 0).toString(),
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                if (user == null || user.permissions.isEmpty)
                  const Text(
                    'لا توجد صلاحيات مرتبطة بالمستخدم الحالي.',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Row(
            children: <Widget>[
              Icon(icon, color: AppPalette.royalBlue),
  ...
  Widget _adminIdentityPageSection() {
    ...
    final identityFields = <MapEntry<String, TextEditingController>>[
      ...
      MapEntry('رئيس مجلس الإدارة', _secretaryNameController),
      MapEntry('المدير', _principalNameController),
      MapEntry('أمانة السر والأشراف العام', _secretaryRoleNameController),
          ...
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                const Text(
                  'هذه الصفحة مخصصة للاعتماد الرسمي وبيانات التواصل المعتمدة للمدرسة (وليست مجرد بيانات اتصال عامة). يمكنك التعديل ثم الحفظ في SQLite. استخدم Tab أو Enter للانتقال للحقل التالي.',
                  ...
                  children: <Widget>[
                    for (var i = 0; i < identityFields.length; i++)
                      _editableField(
                        ...
                        nextFocusNode: i < identityFields.length - 1
                            ? _identityFocusNodes[i + 1]
                            : null,
                      ),
                  ],
                ),
          ...
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                const Text(
                  'تحديد القيم المالية للأقساط والمواصلات. هذه القيم تُستخدم عند إضافة أقساط من باب المحاسبة.',
                  style: TextStyle(color: AppPalette.muted),
                ),
                const SizedBox(height: 14),
                Wrap(
                  ...
                  runSpacing: 12,
                  children: <Widget>[
                    _installmentConfigCard(
                      title: 'القسط بدون مواصلات',
          ...
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                const SizedBox(height: 10),
                const Text(
                  'جميع الحقول مطلوبة ويجب التأكد من تطابق كلمة المرور وتأكيدها مع اختيار الصلاحيات المطلوبة.',
                  style: TextStyle(color: AppPalette.muted),
                ),
                const SizedBox(height: 10),
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      color: AppPalette.roseRed.withValues(alpha: 0.35),
                    ),
                  ),
                  child: const Text(
                  ...
                  children: <Widget>[
                    for (var i = 0; i < adminUserFields.length; i++)
                      _editableField(
                        ...
                        nextFocusNode: i < adminUserFields.length - 1
                            ? _adminUserFocusNodes[i + 1]
                            : null,
                        obscureText: adminUserFields[i].key.contains(
                          'كلمة المرور',
                        ),
                      ),
                    _choiceField(
                      ...
                      <String, bool>{
                        ...
                        'أمانة السر': _adminPermissionsDraft.contains(
                          'أمانة السر',
                        ),
                        'الامتحانات': _adminPermissionsDraft.contains(
                          'الامتحانات',
                        ),
                    ...
                    (user) => Container(
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          padding: const EdgeInsets.all(14),
                          decoration: BoxDecoration(
                            color: _selectedAdminUserId == user.id
                                    ...
                                    child: Row(
                                      children: <Widget>[
                                        ...
                                        Expanded(
                                          flex: 2,
                                          child: Center(
                                            child: _statusChip(student.status),
                                          ),
                                        ),
                                        Expanded(
                                          flex: 2,
                                          child: _studentActions(student),
                                        ),
                                      ],
                                    ),
                                  ),
  ...
  Widget _studentsGradeOverviewPanel(List<StudentRecord> students) {
    ...
    final selected = students
        .where(
          (s) =>
              matchGrade(s, _studentsStatsGrade) &&
              matchSection(s, _studentsStatsSection),
        )
        .toList();
            ...
            children: <Widget>[
              Expanded(
                child: DropdownButtonFormField<String>(
                  initialValue: grades.contains(_studentsStatsGrade)
                      ? _studentsStatsGrade
                      : 'الكل',
                  isExpanded: true,
              ...
              Expanded(
                child: DropdownButtonFormField<String>(
                  initialValue: sections.contains(_studentsStatsSection)
                      ? _studentsStatsSection
                      : 'الكل',
                  isExpanded: true,
                  decoration: InputDecoration(
                    labelText: 'الشعبة',
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  final list = students.where((s) {
                    return matchGrade(s, _studentsStatsGrade) &&
                        matchSection(s, sec);
                  }).toList();
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          colors: <Color>[Color(0xFF132556), Color(0xFF0F1F45)],
        ),
    ...
    return InkWell(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: active ? AppPalette.royalBlue : const Color(0xFFE2EBF2),
          ),
          boxShadow: active
              ? [
                  BoxShadow(
                    color: AppPalette.royalBlue.withValues(alpha: 0.2),
                    blurRadius: 8,
        ...
        child: Row(
          ...
          children: <Widget>[
            Icon(
              ...
              color: active
                  ? Colors.white
                  : AppPalette.royalBlue.withValues(alpha: 0.6),
            ),
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: isFemale
                            ? AppPalette.roseRed.withValues(alpha: 0.35)
                            : AppPalette.royalBlue.withValues(alpha: 0.35),
                      ),
                    ),
                    child: Text(
                      isFemale ? 'أنثى' : 'ذكر',
        ...
        children: <Widget>[
          ...
          _accordion(
            ...
            _wrapFields(<Widget>[
              _subSectionBanner(
                'إعدادات اللغات',
                subtitle:
                    'اختر اللغة الأولى والثانية واللغة التي يجيدها الطالب، وأدخل النص الحر عند اختيار OTHER.',
              ),
              _choiceField(
                'اللغة الأولى',
                <String, bool>{
          ...
          _accordion(
            ...
            _wrapFields(<Widget>[
              ...
              if ((int.tryParse(_enrollmentGrade.trim()) ?? 0) >= 10 &&
                  (int.tryParse(_enrollmentGrade.trim()) ?? 0) <= 12)
                _choiceField(
                  'الفرع (للصفوف 10-12)',
                  <String, bool>{
              ...
              if (_enrollmentType == 'طالب منقول')
                ...
                _passiveNoteField(
                  'اسم المدرسة المنقول منها',
                  'يظهر هذا الحقل فقط عند اختيار طالب منقول.',
                  span2: true,
                ),
              if (_enrollmentType == 'طالب منقول')
                _choiceField(
          ...
          _accordion(
            ...
            _wrapFields(<Widget>[
              _subSectionBanner(
                'بيانات النقل والمواصلات',
                subtitle:
                    'يظهر مكان انتظار المدرسة بشكل واضح عند اشتراك الطالب أو إعفائه من رسوم النقل.',
              ),
              _dropdownField(
              ...
              if (_transportSubscription == 'نعم' ||
                  _transportSubscription == 'معفى من رسوم النقل')
                _editableField(
                  'مكان انتظار المدرسة',
              ...
              _choiceField(
                ...
                (key) {
                  setState(() {
                    ...
                    if (key == 'يتيم الوالدين')
                      _orphanParents = !_orphanParents;
                    if (key == 'وحيد') _onlyChild = !_onlyChild;
                    if (key == 'يعيش في مكان مفصل عن العائلة')
                      _livesSeparate = !_livesSeparate;
                  });
                },
                span2: true,
              ),
          ...
          _accordion(
            ...
            _stackedFields(<Widget>[
              ...
              if (_healthStatus == 'إعاقة')
                _subSectionBanner(
                  'تفاصيل الإعاقة',
                  subtitle: 'يمكن تحديد أكثر من نوع واحد عند الحاجة.',
                ),
              if (_healthStatus == 'إعاقة')
                _choiceField(
                  ...
                  (key) {
                    setState(() {
                      ...
                      if (key == 'سمعية')
                        _disabilityHearing = !_disabilityHearing;
                      if (key == 'حركية') _disabilityMotor = !_disabilityMotor;
                      if (key == 'تعلم')
                        _disabilityLearning = !_disabilityLearning;
                    });
                  },
                  span2: true,
                ),
              ...
              _choiceField(
                ...
                (key) {
                  setState(() {
                    ...
                    if (key == 'اختراعات ومشاريع')
                      _initiativeProjects = !_initiativeProjects;
                  });
                },
                span2: true,
              ),
      ...
      child: Column(
        children: <Widget>[
          Container(
            ...
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                colors: <Color>[Color(0xFF191919), Color(0xFF101010)],
              ),
              borderRadius: BorderRadius.only(
                topLeft: Radius.circular(22),
                topRight: Radius.circular(22),
              ...
              children: <Widget>[
                ...
                const Column(
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(height: 2),
                    Text(
                      'التسلسل، الهوية، الطالب — تنقّل بـ Tab أو Enter',
                        ...
                        child: ClipRRect(
                          ...
                          child:
                              (_selectedStudent != null &&
                                  _fileStorage.fileExistsSync(
                                    _selectedStudent!.studentPhotoPath,
                                  ))
                              ? Image.file(
                                  File(_selectedStudent!.studentPhotoPath),
                                  fit: BoxFit.cover,
                                )
                              : Center(
                                  child: Image.asset(
                  ...
                  child: Column(
                    children: <Widget>[
                      Row(
                        children: <Widget>[
                          Expanded(
                            child: _compactLabeledField(
                              'الاسم *',
                              _tabInput(
                                _fullNameController,
                                hint: 'اسم الطالب',
                                node: _formFocusNodes[0],
                                nextNode: _formFocusNodes[1],
                              ),
                            ),
                          ),
                          const SizedBox(width: 10),
                          Expanded(
                            child: _compactLabeledField(
                              ...
                              _tabInput(
                                ...
                                hint: 'اسم الأب',
                                node: _formFocusNodes[1],
                                nextNode: _formFocusNodes[2],
                              ),
                            ),
                          ),
                        ],
                          ...
                          Expanded(
                            child: _compactLabeledField(
                              ...
                              _tabInput(
                                _nicknameController,
                                hint: 'الكنية',
                                node: _formFocusNodes[2],
                                nextNode: _formFocusNodes[3],
                              ),
                            ),
                          ),
                          const SizedBox(width: 10),
                          Expanded(
                            child: _compactLabeledField(
                              ...
                              _tabInput(
                                ...
                                hint: 'اسم الأم',
                                node: _formFocusNodes[3],
                                nextNode: _formFocusNodes[4],
                              ),
                            ),
                          ),
                        ],
                          ...
                          Expanded(
                            child: _compactLabeledField(
                              ...
                              _tabInput(
                                ...
                                hint: 'الجد',
                                node: _formFocusNodes[4],
                                nextNode: _formFocusNodes[5],
                              ),
                            ),
                          ),
                          const SizedBox(width: 10),
                          Expanded(
                            child: _compactLabeledField(
                              ...
                              _tabInput(
                                ...
                                hint: 'مكان الولادة',
                                node: _formFocusNodes[5],
                                nextNode: _formFocusNodes[6],
                              ),
                            ),
                          ),
                        ],
                          ...
                          Expanded(
                            child: _compactLabeledField(
                              ...
                              _tabInput(
                                ...
                                hint: 'مكان القيد',
                                node: _formFocusNodes[7],
                                nextNode: _formFocusNodes[8],
                              ),
                            ),
                          ),
                        ],
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      type,
                      style: TextStyle(
                        color: active ? Colors.white : const Color(0xFF29446F),
                        fontWeight: FontWeight.w800,
                        fontSize: 11,
                      ),
                    ),
      ...
      child: Container(
        ...
        child: DropdownButtonHideUnderline(
          child: DropdownButton<String>(
            value: _religionController.text.isEmpty
                ? 'إسلامية'
  ...
  Widget _accordion(String id, String number, String title, Widget body) {
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(18),
        border: Border.all(
          color: active ? AppPalette.goldDark : const Color(0xFFE8EDF4),
          width: active ? 1.6 : 1,
        ),
        boxShadow: active
            ? const <BoxShadow>[
                BoxShadow(
                  color: Color.fromRGBO(167, 122, 46, 0.18),
                  blurRadius: 12,
                  offset: Offset(0, 4),
                ),
              ]
            : const <BoxShadow>[
                BoxShadow(
                  color: Color.fromRGBO(20, 40, 90, 0.03),
                  blurRadius: 6,
                  offset: Offset(0, 2),
                ),
              ],
              ...
              decoration: BoxDecoration(
                ...
                gradient: active
                    ? const LinearGradient(
                        colors: <Color>[AppPalette.goldDark, AppPalette.gold],
                      )
                    : null,
              ),
              child: Row(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(
              note,
              style: const TextStyle(color: Color(0xFF7B5830), height: 1.7),
            ),
          ],
        ),
      ),
  ...
  List<Map<String, String>> _transportAccountingEntries(int studentId) {
    ...
    for (final entry in _studentInvoices(studentId)) {
      items.add(<String, String>{
        ...
        'subtitle':
            'المبلغ: ${entry.amount.toStringAsFixed(0)} ${entry.currency} • التاريخ: ${entry.date.isEmpty ? 'بدون تاريخ' : entry.date}',
      });
    }
    ...
    if (entries.isEmpty) {
      return <Widget>[
        Container(
          ...
          child: const Text(
            'لا توجد سجلات محاسبية مرتبطة بهذا الطالب حتى الآن.',
            style: TextStyle(color: AppPalette.muted),
          ),
        ),
      ];
      ...
      child: Column(
        children: <Widget>[
          _subSectionBanner(
            'الأقساط والمدفوعات',
            subtitle:
                'تم إخفاء سجل رسوم 1 وما يشابهه هنا، وأصبح العرض يعتمد فقط على السجلات التي تتم إضافتها من باب المحاسبة.',
          ),
          const SizedBox(height: 12),
          if (student != null &&
              student.transportSubscription == 'نعم') ...<Widget>[
            Container(
              width: double.infinity,
              padding: const EdgeInsets.all(14),
              decoration: BoxDecoration(
          ...
          if (student != null) ...<Widget>[
            _subSectionBanner(
              'سجل المحاسبة المرتبط',
              subtitle:
                  'يظهر هنا ما تمت إضافته من باب الأقساط والدفعات: قسط أو مقبوض.',
            ),
            const SizedBox(height: 12),
  ...
  Widget _mediaBlock() {
    final student = _selectedStudent;
    final docs = student == null
        ? <StudentAttachment>[]
        : _studentAttachments(student.id);
                  ...
                  Wrap(
                    ...
                    children: <Widget>[
                      _actionButton(
                        ...
                        AppPalette.goldDark,
                        Colors.white,
                        _generateStudentQrFile,
                      ),
                      _actionButton(
                        'تصدير وحفظ بالوثائق (PDF)',
                        const Color(0xFFE7F7EE),
                        AppPalette.leafGreen,
                        () => _exportStudentQrDocument(asPdf: true),
                      ),
                      _actionButton(
                        'تصدير وحفظ بالوثائق (JPEG)',
                        const Color(0xFFEDF6FF),
                        const Color(0xFF24436F),
                        () => _exportStudentQrDocument(asPdf: false),
                      ),
                      _actionButton(
                        'رفع ملف QR',
              ...
              Column(
                children: <Widget>[
                  ...
                  if (docs.length > 3) ...<Widget>[
                    const SizedBox(height: 8),
                    Text(
                      'يوجد ${docs.length} مرفقات مرتبطة بهذا السجل.',
                      style: const TextStyle(
                        color: AppPalette.muted,
                        fontSize: 12,
                      ),
  ...
  Widget _buildStudentPhotoPreview(StudentRecord? student) {
    final hasPhoto =
        student != null &&
        _fileStorage.fileExistsSync(student.studentPhotoPath);
    return Container(
      height: 180,
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(18),
  ...
  Widget _buildQrPreview(StudentRecord? student) {
    final hasQr =
        student != null && _fileStorage.fileExistsSync(student.qrFilePath);
    return Container(
      height: 180,
      padding: const EdgeInsets.all(12),
      decoration: BoxDecoration(
        ...
        children: <Widget>[
              ...
              Wrap(
                ...
                children: <Widget>[
                  _actionButton(
                    ...
                    Colors.white,
                    () => _showSnack(
                      'Demo Flutter: تم تجهيز ملف CSV متوافق مع Excel.',
                    ),
                  ),
                  _actionButton(
                    'تقرير النقل CSV',
                    ...
                    const Color(0xFF24436F),
                    () => _showSnack(
                      'Demo Flutter: تم تجهيز تقرير النقل بصيغة CSV.',
                    ),
                  ),
                  _actionButton(
                    'تقرير Printable / PDF',
                    ...
                    const Color(0xFF667586),
                    () => _showSnack(
                      'Demo Flutter: تم تجهيز تقرير قابل للطباعة والحفظ كـ PDF.',
                    ),
                  ),
                ],
              ),
          ...
          Row(
            children: <Widget>[
              ...
              _summaryTile(
                'إجمالي عدد المعلمين',
                EmployeeService.instance.all
                    .where((e) => e.jobType == 'معلم')
                    .length
                    .toString(),
                AppPalette.royalBlue,
              ),
              ...
              _summaryTile(
                'إجمالي عدد الموظفين',
                EmployeeService.instance.all.length.toString(),
                AppPalette.leafGreen,
              ),
            ],
          ),
            ...
            children: <Widget>[
              ...
              Wrap(
                ...
                children: <Widget>[
                  ...
                  _actionButton(
                    _isStudentCardExporting
                        ? 'جارٍ تجهيز ملف الطباعة...'
                        : 'تجهيز ملف للطباعة',
                    const Color(0xFFEDF6FF),
                    const Color(0xFF24436F),
                    _isStudentCardExporting
                        ? () {}
                        : _prepareStudentCardForPrint,
                  ),
                  _actionButton(
          ...
          child: Container(
            decoration: BoxDecoration(
              ...
              boxShadow: const <BoxShadow>[
                BoxShadow(
                  color: Color.fromRGBO(20, 40, 90, 0.10),
                  blurRadius: 18,
                  offset: Offset(0, 8),
                ),
              ],
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                _cardInfoLine(
                                  'الشعبة',
                                  _studentSectionDisplay(student),
                                ),
                                _cardInfoLine(
                                  'السنة الدراسية',
                                  student.schoolYear.isEmpty
        ...
        GridView.builder(
          ...
          itemBuilder: (context, index) {
            final palette = top
                ? <Color>[
                    Colors.white,
                    const Color(0xFF6FD0B0),
                    const Color(0xFF3CA0A4),
                    const Color(0xFF2A7AB8),
                  ]
                : <Color>[
                    Colors.white,
                    const Color(0xFF9AE18B),
                    const Color(0xFF6EC0A0),
                    const Color(0xFF4A9FC2),
                  ];
            final color = palette[index % palette.length].withValues(
              alpha: index.isEven ? 0.08 : 0.15,
            );
            return Container(
              decoration: BoxDecoration(
                color: color,
                ...
                child: Center(
                  child: Text(
                    _studentTripleName(student).isEmpty
                        ? 'ط'
                        : _studentTripleName(student).substring(
                            0,
                            _studentTripleName(student).length >= 2 ? 2 : 1,
                          ),
                    style: const TextStyle(
                      color: AppPalette.royalBlue,
                      fontWeight: FontWeight.w900,
  ...
  Map<String, int> _countBy(
    ...
    String Function(StudentRecord) selector,
  ) {
  ...
  Map<String, int> _disabilityCounts() {
    ...
    for (final student in _students) {
      ...
      if (student.disabilityVisual)
        result['بصرية'] = (result['بصرية'] ?? 0) + 1;
      if (student.disabilityHearing)
        result['سمعية'] = (result['سمعية'] ?? 0) + 1;
      if (student.disabilityMotor) result['حركية'] = (result['حركية'] ?? 0) + 1;
      if (student.disabilityLearning)
        result['تعلم'] = (result['تعلم'] ?? 0) + 1;
    }
    if (result.isEmpty) {
      result['لا يوجد'] = 0;
    }
  ...
  String _transportGatheringSummary(StudentRecord student) {
    if (student.transportSubscription == 'نعم') {
      return student.transportGathering.isEmpty
          ? 'غير محدد'
          : student.transportGathering;
    }
              ...
              Wrap(
                ...
                children: <Widget>[
                  ...
                  _actionButton(
                    ...
                    const Color(0xFFE7F7EE),
                    AppPalette.leafGreen,
                    () => _showAttendanceExportDialog(asPdf: false),
                  ),
                  _actionButton(
                    'تصدير PDF',
                    const Color(0xFFF7F3EA),
                    AppPalette.goldDark,
                    () => _showAttendanceExportDialog(asPdf: true),
                  ),
                ],
              ),
            ],
          ...
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                if (entries.isEmpty)
                  const Text(
                    'لا توجد سجلات حضور/غياب لهذا الطالب حتى الآن.',
                    style: TextStyle(color: AppPalette.muted),
                  )
                else
                  ...entries.map(
  ...
  List<PaymentEntry> _activeFeeEntries(StudentRecord student) {
    return student.transportSubscription == 'نعم'
        ? student.transportFees
        : student.regularFees;
  }

  double _sumFeeDue(StudentRecord student) {
    return _activeFeeEntries(
      student,
    ).fold(0, (sum, e) => sum + (double.tryParse(e.dueAmount) ?? 0));
  }

  double _sumFeePaid(StudentRecord student) {
    return _activeFeeEntries(
      student,
    ).fold(0, (sum, e) => sum + (double.tryParse(e.paidAmount) ?? 0));
  }
            ...
            children: <Widget>[
              SizedBox(
                ...
                child: _actionButton(
                  ...
                  AppPalette.goldDark,
                  Colors.white,
                  () => Navigator.pop(dialogContext, 'مادية'),
                ),
              ),
              const SizedBox(height: 10),
              SizedBox(
                ...
                child: _actionButton(
                  ...
                  const Color(0xFFEDF6FF),
                  const Color(0xFF24436F),
                  () => Navigator.pop(dialogContext, 'عينية'),
                ),
              ),
            ],
          ),
        ...
        return StatefulBuilder(
          builder: (context, setDialogState) {
            ...
            String effectiveCurrencyFor(Map<String, dynamic> draft) {
              ...
              final otherCurrencyController =
                  draft['otherCurrencyController'] as TextEditingController;
              return selectedCurrency == 'أخرى'
                  ? (otherCurrencyController.text.trim().isEmpty
                        ? 'أخرى'
            ...
            void autofillPaymentDraft(Map<String, dynamic> draft) {
              ...
              final amountController =
                  draft['amountController'] as TextEditingController;
              final localDateController =
                  draft['dateController'] as TextEditingController;
            ...
            return AlertDialog(
              title: Text(
                kind == 'مادية' ? 'إضافة تبرع مادي' : 'إضافة تبرع عيني',
              ),
              content: SizedBox(
                width: 660,
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: <Widget>[
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        ...
                                        const SizedBox(height: 4),
                                        Text(
                                          _donationDisplaySubtitle(entry),
                                          style: const TextStyle(
                                            color: AppPalette.muted,
                                            fontSize: 12,
                                            height: 1.5,
                      ...
                      if (kind == 'مادية') ...<Widget>[
                        ...paymentDrafts.asMap().entries.map(
                          (entry) => paymentDraftCard(entry.value, entry.key),
                        ),
                        _actionButton(
                          'إضافة قالب دفع',
                          const Color(0xFFE7F7EE),
                        ...
                        TextField(
                          ...
                          maxLines: 3,
                          onTap: () =>
                              _clearNoteFieldOnFirstTap(noteController),
                          decoration: const InputDecoration(
                            labelText: 'ملاحظات',
                          ),
                        ),
              ...
              actions: <Widget>[
                ...
                TextButton(
                  onPressed: () {
                    if (kind == 'مادية') {
                      ...
                      _showSnack(
                        'تم حفظ ${validDrafts.length} قالب/قوالب تبرع بنجاح.',
                      );
                      return;
                    }
                    ...
                    final entry = AccountingDonationEntry(
                      studentId: student.id,
                      title: materialTypeController.text.trim().isEmpty
                          ? 'تبرع عيني'
                  ...
                  onPressed: selectedEntry == null
                      ...
                      : () {
                          if (kind == 'مادية') {
                            ...
                            final index = _accountingDonations.indexOf(
                              selectedEntry!,
                            );
                            if (index >= 0) {
                              setState(() {
                ...
                TextButton(
                  ...
                  child: const Text(
                    'حذف',
                    style: TextStyle(color: AppPalette.roseRed),
                  ),
                ),
              ],
            );
      ...
      builder: (dialogContext) {
        return StatefulBuilder(
          builder: (context, setDialogState) {
            ...
            return AlertDialog(
              title: Text(
                kind == 'مادية' ? 'إضافة مساعدة مادية' : 'إضافة مساعدة عينية',
              ),
              content: SizedBox(
                width: 660,
                child: SingleChildScrollView(
                ...
                TextButton(
                  onPressed: () {
                    if (kind == 'مادية') {
                      ...
                      Navigator.pop(dialogContext);
                      _showSnack(
                        'تم حفظ ${validDrafts.length} قالب/قوالب مساعدة بنجاح.',
                      );
                      return;
                    }
                ...
                TextButton(
                  onPressed: selectedEntry == null
                      ...
                      : () {
                          if (kind == 'مادية') {
                            final draft = paymentDrafts.first;
                            final index = _accountingAids.indexOf(
                              selectedEntry!,
                            );
                            if (index >= 0) {
                              setState(() {
  ...
  IncomeCategory _resolveIncomeCategory(
    String preferredId,
  ...
  Future<void> _pushIncomeFromAccounting({
    ...
    final cat = _resolveIncomeCategory(
      preferredCategoryId,
  ...
  Future<void> _showInstallmentPresetDialog({
    String presetType = 'normal',
  }) async {
    ...
    final monthly =
        double.tryParse(_installmentMonthlyController.text.trim()) ?? 20000;
    final transportMonthly =
        double.tryParse(_transportMonthlyController.text.trim()) ?? 5000;
    final grantAmount =
        double.tryParse(_transportGrantController.text.trim()) ?? 25000;
    final maxCount =
        (int.tryParse(_installmentCountController.text.trim()) ?? 10).clamp(
          1,
          36,
        );
    final exemptionMonths =
        int.tryParse(_exemptionMonthsController.text.trim()) ?? 3;
    final currency =
        const <String>[
          'ليرة سورية',
          'دولار',
          'يورو',
        ].contains(_installmentCurrency)
        ? _installmentCurrency
        : 'ليرة سورية';
      ...
      builder: (dialogContext) {
        return StatefulBuilder(
          builder: (context, setDialogState) {
            ...
            final existingCount = items
                .where((e) => e.title.startsWith(titlePrefix))
                .length;
            ...
            final paidTotal = _studentReceipts(
              student.id,
            ).fold<double>(0, (sum, e) => sum + e.amount);
                    ...
                    onPressed: !canAdd
                        ...
                        : () async {
                            ...
                            final installmentTitle =
                                '$titlePrefix — قسط $nextIndex/$maxCount';
                            final confirmed =
                                await _confirmInstallmentSaveDialog(
                                  studentName: studentName,
                                  amount: unitAmount,
                                  currency: currency,
                                  date: dueLabel,
                            ...
                            await _pushIncomeFromAccounting(
                              ...
                              date: paidDate,
                              description:
                                  'قسط/سداد: $installmentTitle — الطالب: $studentName',
                              studentId: selectedStudentId,
                              studentName: studentName,
                            );
                            await NotificationService.instance
                                .markInstallmentPaidForStudent(
                                  studentId: selectedStudentId,
                                  studentName: studentName,
                                  amount: unitAmount,
                                  currency: currency,
                            ...
                            final stillOverdue =
                                _studentsWithOverdueInstallments()
                                    .map((s) => s.id)
                                    .toSet();
                            await NotificationService.instance
                                .clearDueForStudentsNotIn(stillOverdue);
                            if (Navigator.of(dialogContext).canPop()) {
                              Navigator.of(dialogContext).pop();
                            }
                            if (mounted) {
  ...
  Future<void> _showStudentPaymentDialog({StudentRecord? student}) async {
    final target =
        student ??
        _selectedStudent ??
        (_students.isEmpty ? null : _students.first);
    if (target == null) {
              ...
              actions: <Widget>[
                ...
                TextButton(
                  onPressed: () async {
                    ...
                    final payTitle = titleController.text.trim().isEmpty
                        ? 'دفعة'
                        : titleController.text.trim();
                    final typedDate = dateController.text.trim();
                    final payDate = DateTime.now()
                        .toIso8601String()
                        .split('T')
                        .first; // always today for auto settlement
                    final payNote = () {
                      final base = noteController.text.trim().isEmpty
                          ? 'دفعة من المحاسبة'
                    ...
                    await _pushIncomeFromAccounting(
                      ...
                      date: payDate,
                      description:
                          'دفعة: $payTitle — الطالب: $studentName${payNote.isEmpty ? '' : ' — $payNote'}',
                      studentId: selectedStudentId,
                      studentName: studentName,
                    );
                    await NotificationService.instance
                    ...
                    final stillOverdue = _studentsWithOverdueInstallments()
                        .map((s) => s.id)
                        .toSet();
                    ...
                    _showSnack(
                      'تم الدفع تلقائيًا: ${studentName} → أخضر (تم الدفع). العدد في المستحقين ينقص فورًا.',
                    );
                  },
                  ...
                  createDraft(
                    ...
                    currency:
                        const <String>[
                          ...
                          'دولار',
                          'يورو',
                        ].contains(item['currency'].toString())
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        ...
                                        const SizedBox(height: 4),
                                        Text(
                                          '${(item['amount'] as num).toStringAsFixed(0)} ${item['currency']} • ${item['date']}',
                                          style: const TextStyle(
                                            color: AppPalette.muted,
                                            fontSize: 12,
                                          ),
                    ...
                    for (final draft in validDrafts) {
                      ...
                      final date =
                          ...
                          : (draft['dateController'] as TextEditingController)
                                ...
                                .trim();
                      onSave(
                        info.isEmpty ? 'معلومات الدفع' : info,
                        amount,
                        effectiveCurrencyFor(draft),
                        date,
                      );
                    }
                    Navigator.pop(dialogContext);
                    _showSnack(
                      'تم حفظ ${validDrafts.length} قالب/قوالب دفع بنجاح.',
                    );
                  },
                  child: const Text('حفظ'),
                ),
  ...
  int _compareAccountingEntryMeta(
    int firstStudentId,
    String firstDate,
    int secondStudentId,
    String secondDate,
    ...
    if (firstStudent != null && secondStudent != null) {
      final studentCompare = _compareAccountingStudents(
        firstStudent,
        secondStudent,
      );
      if (studentCompare != 0) {
  ...
  bool _accountingMatchesFilters(int studentId) {
    ...
    if (_accountingFilterStudentId != null &&
        student.id != _accountingFilterStudentId) {
      return false;
    }
    if (_accountingSectionFilter != 'الكل' &&
        _studentSectionDisplay(student) != _accountingSectionFilter) {
      return false;
    }
    if (_accountingGradeFilter != 'الكل' &&
        _studentGradeDisplay(student) != _accountingGradeFilter) {
      return false;
    }
  ...
  List<AccountingInvoiceEntry> _filteredAccountingInvoices() {
    final result = _invoices
        .where((entry) => _accountingMatchesFilters(entry.studentId))
        .toList();
    result.sort(
      (first, second) => _compareAccountingEntryMeta(
        first.studentId,
        first.date,
        second.studentId,
        second.date,
  ...
  List<AccountingDonationEntry> _filteredAccountingDonations() {
    final result = _accountingDonations
        .where((entry) => _accountingMatchesFilters(entry.studentId))
        .toList();
    result.sort(
      (first, second) => _compareAccountingEntryMeta(
    ...
    return SizedBox(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: const <BoxShadow>[
            BoxShadow(
              color: Color.fromRGBO(20, 40, 90, 0.05),
              blurRadius: 12,
              offset: Offset(0, 6),
            ),
          ],
    ...
    return InkWell(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          gradient: active
              ? LinearGradient(
                  colors: <Color>[accent, accent.withValues(alpha: 0.80)],
                )
              : null,
          ...
          boxShadow: <BoxShadow>[
            BoxShadow(
              color: active
                  ...
                  : const Color.fromRGBO(20, 40, 90, 0.06),
            ...
            Row(
              children: <Widget>[
                Container(
                  ...
                  height: 48,
                  decoration: BoxDecoration(
                    color: active ? Colors.white.withValues(alpha: 0.18) : soft,
                    borderRadius: BorderRadius.circular(16),
                  ),
                ...
                Icon(
                  active ? Icons.check_circle : Icons.chevron_left,
              ...
              children: <Widget>[
                ...
                Wrap(
                  ...
                  children: <Widget>[
                    ...
                    _pill(
                      'الشعبة ${_studentSectionDisplay(student)}',
                      const Color(0xFFEDF6FF),
                      AppPalette.royalBlue,
                    ),
                    _pill(
                      'الصف ${_studentGradeDisplay(student)}',
                      const Color(0xFFF7F3EA),
                      AppPalette.goldDark,
                    ),
                  ],
  ...
  List<Widget> _buildAccountingInstallmentTiles(
    List<AccountingInvoiceEntry> entries,
  ) {
    return entries.map((entry) {
      ...
      return _accountingRecordTile(
        ...
        title: entry.title,
        subtitle:
            'المبلغ: ${entry.amount.toStringAsFixed(0)} ${entry.currency} • التاريخ: ${entry.date.isEmpty ? 'بدون تاريخ' : entry.date} • للقراءة فقط',
        pillText: 'قسط',
  ...
  List<Widget> _buildAccountingPaymentTiles(
    List<AccountingReceiptEntry> entries,
  ) {
    return entries.map((entry) {
      final student = _studentById(entry.studentId);
      if (student == null) return const SizedBox.shrink();
      return _accountingRecordTile(
        ...
        title: entry.title,
        subtitle:
            'المبلغ: ${entry.amount.toStringAsFixed(0)} ${entry.currency} • التاريخ: ${entry.date.isEmpty ? 'بدون تاريخ' : entry.date}${entry.note.isEmpty ? '' : ' • ${entry.note}'}',
        pillText: 'دفعة',
  ...
  List<Widget> _buildAccountingDonationTiles(
    List<AccountingDonationEntry> entries,
  ) {
    return entries.map((entry) {
      final student = _studentById(entry.studentId);
      if (student == null) return const SizedBox.shrink();
  ...
  Widget _accountingPageSection() {
    ...
    final transportEntries = installmentEntries
        .where(
          (entry) =>
              entry.title.contains('قسط المواصلات') ||
              entry.title.contains('قسط مع مواصلات'),
        )
        .toList();
    final filteredStudentIds = filteredStudents
        .map((student) => student.id)
        .toSet();
    final receiptEntries = _receipts
        .where((entry) => filteredStudentIds.contains(entry.studentId))
        .toList();
    final installmentsTotal = installmentEntries.fold<double>(
      0,
      (sum, entry) => sum + entry.amount,
    );
    final monthlyInstallmentAmount = installmentEntries
        .where(
          (entry) =>
              !entry.title.contains('قسط المواصلات') &&
              !entry.title.contains('قسط مع مواصلات'),
    ...
    final annualWithoutTransport =
        double.tryParse(_installmentAnnualController.text.trim()) ?? 0;
    final totalAmount = filteredStudents.length * annualWithoutTransport;
    final transportAmount = transportEntries.fold<double>(
      0,
      (sum, entry) => sum + entry.amount,
    );
    final monthlyAmount = monthlyInstallmentAmount;
    final remainingAmount = totalAmount - monthlyAmount;
    final netAmount = monthlyAmount + transportAmount;
    final annualPaidInFull = totalAmount > 0 && monthlyAmount >= totalAmount;

    String focusedTitle = 'شاشة الأقساط';
    String focusedSubtitle = '';
    Color focusedAccent = AppPalette.goldDark;
    IconData focusedIcon = Icons.account_balance_wallet_outlined;
    List<Widget> focusedChildren = const <Widget>[];
    ...
    switch (_accountingView) {
      case 'transport_installments':
        focusedTitle = 'قسط المواصلات';
        focusedSubtitle =
            '${_accountingScopeText(filteredStudents.length)} • عرض ${transportEntries.length} سجلًا';
        focusedAccent = AppPalette.royalBlue;
        focusedIcon = Icons.directions_bus_outlined;
        focusedChildren = _buildAccountingInstallmentTiles(transportEntries);
        break;
      case 'payments':
        focusedTitle = 'شاشة الدفعات';
        focusedSubtitle =
            '${_accountingScopeText(filteredStudents.length)} • عرض ${receiptEntries.length} دفعة';
        focusedAccent = const Color(0xFF0F766E);
        focusedIcon = Icons.payments_outlined;
        focusedChildren = receiptEntries.isEmpty
            ? const <Widget>[
                Text(
                  'لا توجد دفعات ضمن الفرز الحالي. استخدم زر «دفعة» لإضافة دفعة.',
                  style: TextStyle(color: AppPalette.muted),
                ),
              ]
      ...
      case 'dues':
        ...
        focusedSubtitle =
            'مستحق: $dueOnlyCount • تم الدفع: $paidOnlyCount • اضغط البطاقة لإدارة الأسماء';
      ...
      default:
        ...
        focusedSubtitle =
            '${_accountingScopeText(filteredStudents.length)} • عرض ${installmentEntries.length} سجلًا';
        ...
        focusedChildren = installmentEntries.isEmpty
            ? const <Widget>[
                Text(
                  'لا توجد أقساط مضافة ضمن الفرز الحالي.',
                  style: TextStyle(color: AppPalette.muted),
                ),
              ]
          ...
          Wrap(
            ...
            children: <Widget>[
              _accountingSummaryBox(
                ...
                annualPaidInFull ? AppPalette.leafGreen : AppPalette.goldDark,
                backgroundColor: annualPaidInFull
                    ? const Color(0xFFE7F7EE)
                    : null,
              ...
              _accountingSummaryBox(
                'قسط المواصلات',
                transportAmount.toStringAsFixed(0),
                AppPalette.royalBlue,
              ),
              _accountingSummaryBox(
                'الصافي',
            ...
            child: Column(
              ...
              children: <Widget>[
                  ...
                  child: Row(
                    children: <Widget>[
                      Expanded(
                        child: Column(
                          ...
                          children: const <Widget>[
                            ...
                            SizedBox(height: 6),
                            Text(
                              'تنسيق أحدث وأكثر انسيابية مع الحفاظ على نفس المعلومات الأساسية وربطها الكامل بالمحاسبة.',
                              style: TextStyle(
                                color: Colors.white70,
                                height: 1.7,
                              ),
                      ...
                      Container(
                        ...
                        child: Text(
                          _accountingScopeText(filteredStudents.length),
                          style: const TextStyle(
                            color: Colors.white,
                            fontWeight: FontWeight.w800,
                            fontSize: 12,
                ...
                _subSectionBanner(
                  'الأقساط والدفعات',
                  subtitle:
                      'الأقساط والدفعات فقط. كل قسط/دفعة يُرحَّل تلقائيًا للإيرادات. شاشات التبرعات/المساعدات أُزيلت من هذا الباب.',
                ),
                const SizedBox(height: 14),
                Wrap(
                  spacing: 12,
                  ...
                  children: <Widget>[
                    _accountingFilterCard(
                      ...
                      child: DropdownButtonFormField<String>(
                        initialValue:
                            _accountingFilterStudentId?.toString() ?? 'all',
                        isExpanded: true,
                        decoration: InputDecoration(
                          filled: true,
                          fillColor: const Color(0xFFFBFDFF),
                        ...
                        onChanged: (value) {
                          ...
                          setState(() {
                            if (value == 'all') {
                              ...
                              final selected = _studentById(
                                _accountingFilterStudentId!,
                              );
                              if (selected != null) {
                                _loadStudent(selected);
                            ...
                            (context, controller, focusNode, onFieldSubmitted) {
                              ...
                              if (controller.text !=
                                  ...
                                  _accountingStudentSearchController
                                      ...
                                      .isNotEmpty) {
                                controller.value =
                                    _accountingStudentSearchController.value;
                              }
                              return TextField(
                                controller: controller,
                                focusNode: focusNode,
                    ...
                    _accountingFilterCard(
                      ...
                      child: DropdownButtonFormField<String>(
                        initialValue:
                            _accountingAvailableGrades().contains(
                              _accountingGradeFilter,
                            )
                            ? _accountingGradeFilter
                            : 'الكل',
                        isExpanded: true,
                    ...
                    _accountingFilterCard(
                      ...
                      child: DropdownButtonFormField<String>(
                        initialValue:
                            _accountingAvailableSections().contains(
                              _accountingSectionFilter,
                            )
                            ? _accountingSectionFilter
                            : 'الكل',
                        isExpanded: true,
                  ...
                  children: <Widget>[
                    ...
                    Expanded(
                      child: _accountingTypeCard(
                        ...
                        title: 'المستحقون',
                        subtitle:
                            'شاشة مستقلة: أصفر مستحق / أخضر تم الدفع + خيارات.',
                        count: dueOnlyCount,
  ...
  List<Widget> feeEntriesWidgets({required List<PaymentEntry> feeEntries}) {
    if (feeEntries.isEmpty) {
      return const <Widget>[
        Text(
          'لا توجد دفعات رسوم مسجلة حتى الآن.',
          style: TextStyle(color: AppPalette.muted),
        ),
      ];
    }
    return feeEntries
        .asMap()
        .entries
        .map((entry) => _accountingFeeTile(entry.key + 1, entry.value))
        .toList();
  }
          ...
          Expanded(
            child: Column(
              ...
              children: <Widget>[
                ...
                const SizedBox(height: 4),
                Text(
                  'المستحق: ${entry.dueAmount.isEmpty ? '0' : entry.dueAmount} • المقبوض: ${entry.paidAmount.isEmpty ? '0' : entry.paidAmount} • ${entry.currency}',
                  style: const TextStyle(
                    color: AppPalette.muted,
                    fontSize: 12,
                    height: 1.6,
  ...
  Widget _accountingEntryTile(
    String title,
    double amount,
    String currency,
    String date,
  ) {
    return _accountingEntryRichTile(
      title,
      '${amount.toStringAsFixed(0)} $currency • $date',
    );
  }
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      if (docs.isEmpty)
                        const Text(
                          'لا توجد مرفقات إضافية لهذا الطالب حتى الآن.',
                          style: TextStyle(color: AppPalette.muted),
                        )
                      else
                        ...docs.map(
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              const SizedBox(height: 4),
                              Text(
                                '${backup.createdAt} • ملفات: ${backup.fileCount} • طلاب: ${backup.studentCount}',
                                style: const TextStyle(
                                  color: AppPalette.muted,
                                  fontSize: 12,
                                  height: 1.6,
                          ...
                          children: <Widget>[
                            IconButton(
                              onPressed: () => _showSnack(
                                'تمت استعادة النسخة ${backup.name} (Demo).',
                              ),
                              icon: const Icon(
                                Icons.restore,
                                color: AppPalette.royalBlue,
  ...
  Future<void> _launchExternalUri(Uri uri) async {
    ...
    if (Platform.isWindows) {
      ...
      if (result.exitCode != 0) {
        final fallback = await Process.run('cmd', <String>[
          '/c',
          'start',
          '',
          raw,
          ...
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                if (entries.isEmpty)
                  const Text(
                    'لا توجد مكافآت أو عقوبات لهذا الطالب حتى الآن.',
                    style: TextStyle(color: AppPalette.muted),
                  )
                else
                  ...entries.map(
              ...
              Wrap(
                ...
                children: <Widget>[
                  ...
                  _actionButton(
                    ...
                    const Color(0xFFE7F7EE),
                    AppPalette.leafGreen,
                    _exportSelectedStudentCertificatePdf,
                  ),
                ],
              ),
            ],
          ...
          Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                if (entries.isEmpty)
                  const Text(
                    'لا توجد شهادات لهذا الطالب حتى الآن.',
                    style: TextStyle(color: AppPalette.muted),
                  )
                else
                  ...entries.map(
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          IconButton(
                            tooltip: 'تصدير PDF',
                            onPressed: () =>
                                _exportCertificatePdf(student, entry),
                            icon: const Icon(
  ...
  Future<void> _showAttendanceExportDialog({required bool asPdf}) async {
    final current =
        _selectedStudent ?? (_students.isEmpty ? null : _students.first);
    if (current == null) {
    ...
    if (!grades.contains(selectedGrade) && grades.isNotEmpty)
        ...
        return StatefulBuilder(
          builder: (context, setDialogState) {
            ...
            final studentsForPick = _students.where((s) {
              ...
              final sec =
                  selectedSection == 'الكل' ||
                  _studentSectionDisplay(s) == selectedSection;
              return g && sec;
            }).toList();
            if (studentsForPick.isNotEmpty &&
                !studentsForPick.any((s) => s.id == selectedStudentId)) {
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    DropdownButtonFormField<String>(
                      ...
                      onChanged: (v) =>
                          setDialogState(() => mode = v ?? 'student'),
                    ),
                    const SizedBox(height: 10),
                    DropdownButtonFormField<String>(
                      initialValue: grades.contains(selectedGrade)
                          ? selectedGrade
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      items: sectionList
                          .map(
                            (s) => DropdownMenuItem(
                              value: s,
                              child: Text(s == 'الكل' ? 'كل الشعب' : s),
                            ),
                          )
                          .toList(),
                      onChanged: (v) =>
                          setDialogState(() => selectedSection = v ?? 'الكل'),
                    ),
                    if (mode == 'student') ...<Widget>[
                      ...
                      DropdownButtonFormField<int>(
                        ...
                        items: studentsForPick
                            ...
                            .toList(),
                        onChanged: (v) => setDialogState(
                          () => selectedStudentId = v ?? selectedStudentId,
                        ),
                      ),
                    ],
                  ],
  ...
  Future<void> _exportAttendance({
    ...
    if (mode == 'student') {
      final student =
          _studentById(studentId) ?? _selectedStudent ?? _students.first;
    ...
    if (asPdf) {
        ...
        pw.MultiPage(
          ...
          header: (context) => pw.Column(
            children: [
              ...
              pw.Text(
                'تقرير الحضور والغياب • $scopeLabel',
          ...
          footer: (context) => pw.Row(
            ...
            children: [
              ...
              pw.Text(
                'مدير المدرسة: ${_principalNameController.text.isEmpty ? 'مدير المدرسة' : _principalNameController.text}',
                style: const pw.TextStyle(fontSize: 9),
              ),
            ],
          ),
      ...
      for (final r in rows) {
        buffer.writeln(
          '"${r['student']}","${r['serial']}","${r['grade']}","${r['section']}","${r['status']}","${r['date']}","${r['note']}"',
        );
      }
  ...
  Future<void> _exportCertificatePdf(
    ...
    final supervisor = _supervisorNameController.text.trim().isEmpty
        ? 'مشرف القسم'
    ...
    final manager = _principalNameController.text.trim().isEmpty
        ? (_secretaryNameController.text.trim().isEmpty
              ? 'مدير المدرسة'
              : _secretaryNameController.text.trim())
        ...
        build: (context) {
          return pw.Column(
            ...
            children: <pw.Widget>[
              ...
              pw.Text(
                'تُمنح هذه الشهادة إلى الطالب/ة: ${student.fullName}',
                style: const pw.TextStyle(fontSize: 13),
              ),
              pw.SizedBox(height: 8),
              pw.Text(
                'الصف: ${_studentGradeDisplay(student)}    الشعبة: ${_studentSectionDisplay(student)}',
                style: const pw.TextStyle(fontSize: 12),
              ),
              pw.SizedBox(height: 8),
              pw.Text(
              ...
              pw.Text(
                entry.note.isEmpty ? 'مع تمنياتنا بالتوفيق.' : entry.note,
                style: const pw.TextStyle(fontSize: 12),
              ),
              pw.Spacer(),
              pw.Row(
    ...
    final filePath = p.join(
      reports.path,
      'certificate_${student.id}_$stamp.pdf',
    );
    await File(filePath).writeAsBytes(bytes, flush: true);
    await Printing.layoutPdf(
      onLayout: (_) async => bytes,
      name: 'certificate_${student.fullName}.pdf',
    );
                  ...
                  builder: (ctx) {
                    return StatefulBuilder(
                      builder: (context, setLocal) {
                        return AlertDialog(
                          title: Text(
                            action == 'rename' ? 'تعديل اسم مادة' : 'حذف مادة',
                          ),
                          content: SizedBox(
                            width: 420,
                            child: Column(
                ...
                if (action == 'rename') {
                  ...
                  setState(() {
                    _customExamSubjects = _customExamSubjects
                        .where((s) => s != selected)
                        .toList();
                    _examResults.removeWhere(
                      (r) => r.studentId == student.id && r.subject == selected,
                    );
                      ...
                      child: subjects.isEmpty
                          ...
                          : ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final isCustom = _customExamSubjects.contains(
                                  subject,
                                );
                                return Container(
                                  margin: const EdgeInsets.only(bottom: 8),
  ...
  Future<void> _showAddExamSubjectDialog(StudentRecord student) async {
          ...
          actions: <Widget>[
            ...
            TextButton(
              onPressed: () => Navigator.of(
                dialogContext,
              ).pop(_newExamSubjectController.text.trim()),
    ...
    if (_examSubjectsForStudent(student).contains(name) ||
        _customExamSubjects.contains(name)) {
    ...
    await _persistAll();
    _showSnack(
      'تمت إضافة المادة "$name" وستظهر ضمن خيارات وخصائص باقي المواد.',
    );
  }
  ...
  Future<void> _showParentInvitationDialog() async {
    ...
    _messageDateController.text = DateTime.now()
        .toIso8601String()
        .split('T')
        .first;
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Wrap(
                        ...
                        children:
                            <String>[
                              ...
                              return InkWell(
                                onTap: () =>
                                    setDialogState(() => _messageType = option),
                                borderRadius: BorderRadius.circular(999),
                                child: Container(
                                  padding: const EdgeInsets.symmetric(
                                    horizontal: 12,
                      ...
                      const SizedBox(height: 12),
                      TextField(
                        controller: _messageReasonController,
                        decoration: const InputDecoration(
                          labelText: 'سبب الدعوة',
                        ),
                      ),
                      const SizedBox(height: 12),
                      Row(
                        children: <Widget>[
                          Expanded(
                            child: TextField(
                              controller: _messageDateController,
                              decoration: const InputDecoration(
                                labelText: 'التاريخ',
                              ),
                            ),
                          ...
                          Expanded(
                            child: TextField(
                              controller: _messageTimeController,
                              decoration: const InputDecoration(
                                labelText: 'الساعة',
                              ),
                            ),
                      ...
                      if (_messageType == 'بريد إلكتروني') ...<Widget>[
                        ...
                        TextField(
                          ...
                          decoration: const InputDecoration(
                            labelText:
                                'البريد الإلكتروني لولي الأمر (من استمارة الطالب)',
                      ...
                      if (_messageType == 'واتساب') ...<Widget>[
                        ...
                        TextField(
                          ...
                          decoration: const InputDecoration(
                            labelText:
                                'رقم واتساب ولي الأمر (من استمارة الطالب)',
                      ...
                      TextField(
                        ...
                        maxLines: 4,
                        onTap: () =>
                            _clearNoteFieldOnFirstTap(_messageBodyController),
                        decoration: const InputDecoration(
                          labelText: 'مضمون الدعوة',
                        ),
                      ),
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Text(
                                'سبب الدعوة: ${_messageReasonController.text.isEmpty ? '-' : _messageReasonController.text}',
                              ),
                              Text(
                                'التاريخ: ${_messageDateController.text.isEmpty ? '-' : _messageDateController.text}    الساعة: ${_messageTimeController.text.isEmpty ? '-' : _messageTimeController.text}',
                              ),
                              const SizedBox(height: 10),
                              Text(
                                _messageBodyController.text.isEmpty
                ...
                TextButton(
                  onPressed: () async {
                    ...
                    if (_messageType == 'بريد إلكتروني') {
                      if (emailTo.isEmpty) {
                        _showSnack(
                          'لا يوجد بريد لولي الأمر في استمارة الطالب.',
                        );
                        return;
                      }
                      if (schoolEmail.isEmpty) {
                        _showSnack(
                          'حدّد بريد المدرسة من الهوية والاعتماد أولًا.',
                        );
                        return;
                      }
                    }
                    if (_messageType == 'واتساب') {
                      if (waTo.isEmpty) {
                        _showSnack(
                          'لا يوجد رقم واتساب لولي الأمر في استمارة الطالب.',
                        );
                        return;
                      }
                      if (schoolWa.isEmpty) {
                        _showSnack(
                          'حدّد واتساب المدرسة من الهوية والاعتماد أولًا.',
                        );
                        return;
                      }
                    }
                    ...
                    try {
                      if (_messageType == 'بريد إلكتروني') {
                        final subject = Uri.encodeComponent(
                          'دعوة ولي أمر — ${currentStudent.fullName}',
                        );
                        ...
                        await _launchExternalUri(
                          Uri.parse(
                            'mailto:$emailTo?subject=$subject&body=$mailBody',
                          ),
                        );
    ...
    setState(() {
      _discipline.insert(
        ...
        DisciplineEntry(
          ...
          title: _disciplineTitleController.text.trim().isEmpty
              ? 'إجراء جديد'
              : _disciplineTitleController.text.trim(),
          note: _disciplineNoteController.text.trim().isEmpty
              ? 'تمت إضافته من داخل Flutter.'
              : _disciplineNoteController.text.trim(),
          date: _disciplineDateController.text.trim().isEmpty
              ? DateTime.now().toIso8601String().split('T').first
              : _disciplineDateController.text.trim(),
        ),
      );
    });
  ...
  void _addDemoCertificate() {
    ...
    setState(() {
      _certificates.insert(
        ...
        CertificateEntry(
          studentId: student.id,
          title: _certificateTitleController.text.trim().isEmpty
              ? 'شهادة جديدة'
              : _certificateTitleController.text.trim(),
          kind: _certificateKind,
          date: _certificateDateController.text.trim().isEmpty
              ? DateTime.now().toIso8601String().split('T').first
              : _certificateDateController.text.trim(),
          note: _certificateNoteController.text.trim().isEmpty
              ? 'تمت إضافتها من داخل Flutter.'
              : _certificateNoteController.text.trim(),
        ),
      );
    });
  ...
  void _addDemoReceipt() {
    ...
    setState(() {
      _receipts.insert(
        ...
        AccountingReceiptEntry(
          studentId: student.id,
          title: _receiptTitleController.text.trim().isEmpty
              ? 'مقبوض جديد'
              : _receiptTitleController.text.trim(),
          amount: double.tryParse(_receiptAmountController.text.trim()) ?? 0,
          currency: _receiptCurrency,
          date: _receiptDateController.text.trim().isEmpty
              ? DateTime.now().toIso8601String().split('T').first
              : _receiptDateController.text.trim(),
          note: _receiptNoteController.text.trim().isEmpty
              ? 'تمت إضافته من داخل Flutter.'
  ...
  List<MapEntry<String, String>> get _examCycleOptions =>
      <MapEntry<String, String>>[
        ...
        MapEntry(
          kExamCycleSecondaryLiterary,
          _examCycleLabel(kExamCycleSecondaryLiterary),
        ),
        MapEntry(
          kExamCycleSecondaryScientific,
          _examCycleLabel(kExamCycleSecondaryScientific),
        ),
      ];
  ...
  int _studentGradeNumber(StudentRecord student) {
    final raw =
        '${student.enrollmentGrade} ${student.grade} ${_studentGradeDisplay(student)}'
            .trim();
    // Prefer standalone grade digits 1..12 first.
    final allDigits = RegExp(
      r'(?<!\d)(1[0-2]|[1-9])(?!\d)',
    ).allMatches(raw).toList();
    if (allDigits.isNotEmpty) {
      // enrollmentGrade is usually short and reliable; try it alone first.
      final enrollmentOnly = RegExp(
        r'^(1[0-2]|[1-9])$',
      ).firstMatch(student.enrollmentGrade.trim());
  ...
  bool _studentIsScientificTrack(StudentRecord student) {
    final raw =
        '${student.grade} ${student.enrollmentGrade} ${_studentGradeDisplay(student)}'
            .toLowerCase();
    return raw.contains('علمي') ||
        raw.contains('scientific') ||
        raw.contains('science');
  }
  ...
  bool _studentIsLiteraryTrack(StudentRecord student) {
    final raw =
        '${student.grade} ${student.enrollmentGrade} ${_studentGradeDisplay(student)}'
            .toLowerCase();
    return raw.contains('ادبي') ||
        raw.contains('أدبي') ||
        raw.contains('literary') ||
        raw.contains('ادبية') ||
        raw.contains('أدبية');
  }
  ...
  String _detectExamCycleForStudent(StudentRecord student) {
    ...
    if (_studentIsLiteraryTrack(student)) return kExamCycleSecondaryLiterary;
    if (_studentIsScientificTrack(student))
      return kExamCycleSecondaryScientific;
    final g = student.grade;
    if (g.contains('سابع') || g.contains('ثامن') || g.contains('تاسع'))
  ...
  bool _isMiddleCycleGrade(StudentRecord student) =>
      _activeExamCycleForStudent(student) == kExamCyclePrep;
  bool _isUpperPrimaryGrade(StudentRecord student) =>
      _activeExamCycleForStudent(student) == kExamCycle2;
  bool _isLowerPrimaryGrade(StudentRecord student) =>
      _activeExamCycleForStudent(student) == kExamCycle1;
  ...
  List<String> _examSubjectsForStudent(
    StudentRecord student, {
  ...
  ExamResultEntry _examResultForStudentSubject(
    StudentRecord student,
    String subject,
  ) {
    final index = _examResults.indexWhere(
      (entry) => entry.studentId == student.id && entry.subject == subject,
    );
    if (index >= 0) {
  ...
  double _examFinalAverage(double firstTotal, double secondTotal) =>
      (firstTotal + secondTotal) / 2;
  ...
  Map<String, double> _examReportTotals(
    StudentRecord student,
  ...
  String _examResultLabel(double finalTotal, double maxTotal) {
    ...
    return finalTotal / maxTotal >= 0.4 ? 'ناجح' : 'راسب';
  }

  bool _isFrenchSubject(String subject) {
    final key = _normalizeSubjectKey(subject);
    return key.contains('فرنس') || key.contains('لغةاجنبي');
  }

  bool _isArabicSubject(String subject) {
    final key = _normalizeSubjectKey(subject);
    return key.contains('عربي') || key.contains('العربيه');
  }

  bool _isArabicSkill(String subject) {
    final key = _normalizeSubjectKey(subject);
    return key.contains('مهاراتشفوي') || key.contains('مهاراتكتابي');
  }

  bool _isBehaviorSubject(String subject) =>
      _normalizeSubjectKey(subject).contains('سلوك');

  double _subjectPercentage(StudentRecord student, String subject) {
    final entry = _examResultForStudentSubject(student, subject);
    final finalScore = _examFinalAverage(
      _examTermTotal(entry.firstTermWork, entry.firstTermExam),
      _examTermTotal(entry.secondTermWork, entry.secondTermExam),
    );
    final max = _examSubjectMaxMark(subject, student);
    return max <= 0 ? 0 : finalScore / max * 100;
  }

  /// Final pass/fail rules for the official school stages.
  String _finalResultLabel(StudentRecord student, List<String> subjects) {
    final enteredCount = subjects.where((subject) {
      final entry = _examResultForStudentSubject(student, subject);
      return _isFirstTermEntered(entry) || _isSecondTermEntered(entry);
    }).length;
    if (enteredCount == 0) return 'غير مدخل';

    final cycle = _activeExamCycleForStudent(student);
    final totals = _examReportTotals(student, subjects);
    final overallPercent = totals['percent'] ?? 0;

    if (cycle == kExamCycle1) {
      final weakSubjects = subjects.where((subject) {
        final key = _normalizeSubjectKey(subject);
        final isRequired = _isArabicSkill(subject) || key.contains('رياضيات');
        return isRequired && _subjectPercentage(student, subject) < 40;
      }).length;
      return weakSubjects > 1 ? 'راسب' : 'ناجح';
    }

    if (cycle == kExamCycle2) {
      if (overallPercent < 50) return 'راسب';
      final arabicGroups = subjects.where(_isArabicSkill).toList();
      if (arabicGroups.any(
        (subject) => _subjectPercentage(student, subject) < 50,
      ))
        return 'راسب';
      final otherWeak = subjects.where((subject) {
        if (_isArabicSkill(subject) || _isFrenchSubject(subject)) return false;
        return _subjectPercentage(student, subject) < 40;
      }).length;
      return otherWeak > 2 ? 'راسب' : 'ناجح';
    }

    if (overallPercent < 50) return 'راسب';
    final grade = _studentGradeNumber(student);
    final isSecondary = grade >= 10;
    final isTwelfth = grade == 12;
    final arabic = subjects.where(_isArabicSubject).toList();
    final arabicMin = isTwelfth && _studentIsScientificTrack(student)
        ? 40.0
        : 50.0;
    if (arabic.isNotEmpty &&
        arabic.any(
          (subject) => _subjectPercentage(student, subject) < arabicMin,
        ))
      return 'راسب';

    final behavior = subjects.where(_isBehaviorSubject).toList();
    final behaviorMin = isSecondary ? 70.0 : 60.0;
    if (behavior.isNotEmpty &&
        behavior.any(
          (subject) => _subjectPercentage(student, subject) < behaviorMin,
        ))
      return 'راسب';

    if (isTwelfth) {
      final nonArabic = subjects.where(
        (subject) =>
            !_isArabicSubject(subject) &&
            !_isFrenchSubject(subject) &&
            !_isBehaviorSubject(subject),
      );
      if (nonArabic.any((subject) => _subjectPercentage(student, subject) < 20))
        return 'راسب';
      return 'ناجح';
    }

    final weakOther = subjects.where((subject) {
      if (_isArabicSubject(subject) ||
          _isFrenchSubject(subject) ||
          _isBehaviorSubject(subject))
        return false;
      return _subjectPercentage(student, subject) < 40;
    }).toList();
    if (weakOther.length <= 2) {
      if (weakOther.length == 2) {
        var pairScore = 0.0;
        var pairMax = 0.0;
        for (final subject in weakOther) {
          final entry = _examResultForStudentSubject(student, subject);
          pairScore += _examFinalAverage(
            _examTermTotal(entry.firstTermWork, entry.firstTermExam),
            _examTermTotal(entry.secondTermWork, entry.secondTermExam),
          );
          pairMax += _examSubjectMaxMark(subject, student);
        }
        if (pairMax <= 0 || pairScore / pairMax < 0.40) return 'راسب';
      }
      return 'ناجح';
    }
    return 'راسب';
  ...
  int _countReviewedExamSubjects(StudentRecord student) {
    return _studentExamResults(
      student.id,
    ).where((entry) => entry.isManuallyReviewed).length;
  }
  ...
  List<String> _visibleExamSubjectsForStudent(StudentRecord student) {
    ...
    return subjects
        .where(
          (subject) => !_examResultForStudentSubject(
            student,
            subject,
          ).isManuallyReviewed,
        )
  ...
  Future<void> _markAllExamSubjectsReviewed(StudentRecord student) async {
    ...
    setState(() {
      for (final subject in subjects) {
        ...
        if (index >= 0) {
          _examResults[index] = _examResults[index].copyWith(
  ...
  double _averageFinalForStudent(StudentRecord student) {
    ...
    final sum = active.fold<double>(
      0,
      (total, subject) => total + _examSubjectFinal(student, subject),
    );
  ...
  bool _allFirstTermEnteredForStudent(
    StudentRecord student, {
    ExamResultEntry? override,
  }) {
    final subjects = _examSubjectsForStudent(student);
  ...
  bool _allSecondTermEnteredForStudent(
    StudentRecord student, {
    ExamResultEntry? override,
  }) {
    final subjects = _examSubjectsForStudent(student);
  ...
  Future<void> _toggleExamSubjectReviewed(
    StudentRecord student,
    String subject,
  ) async {
    ...
    _showSnack(
      reviewed ? 'تم وضع علامة تدقيق المادة.' : 'تم إلغاء علامة تدقيق المادة.',
    );
  }

  Future<void> _showExamSubjectEditor(
    StudentRecord student,
    String subject,
  ) async {
    ...
    final firstWorkController = TextEditingController(
      text: _formatExamNumber(existing.firstTermWork),
    );
    final firstExamController = TextEditingController(
      text: _formatExamNumber(existing.firstTermExam),
    );
    final secondWorkController = TextEditingController(
      text: _formatExamNumber(existing.secondTermWork),
    );
    final secondExamController = TextEditingController(
      text: _formatExamNumber(existing.secondTermExam),
    );
    ...
    void enforceMax(
      ...
      if (raw != clamped) {
        ...
        setDialogState(() {});
        _showSnack(
          'لا يمكن إدخال درجة أعلى من العلامة العظمى (${_formatExamNumber(maxMark)}) لمادة $subject.',
        );
      } else {
        setDialogState(() {});
      }
          ...
          return StatefulBuilder(
            builder: (context, setDialogState) {
              Future<void> persistAndClose(bool edited) async {
                final firstWork = _clampExamScore(
                  parseNumber(firstWorkController),
                  maxMark,
                );
                final firstExam = _clampExamScore(
                  parseNumber(firstExamController),
                  maxMark,
                );
                final secondWork = _clampExamScore(
                  parseNumber(secondWorkController),
                  maxMark,
                );
                final secondExam = _clampExamScore(
                  parseNumber(secondExamController),
                  maxMark,
                );
                ...
                final afterFirst = _allFirstTermEnteredForStudent(
                  student,
                  override: updatedEntry,
                );
                final afterSecond = _allSecondTermEnteredForStudent(
                  student,
                  override: updatedEntry,
                );
                ...
                if (messages.isNotEmpty) {
                  ...
                  _showSnack(
                    edited
                        ? 'تم تعديل درجات مادة $subject بنجاح.'
                        : 'تم حفظ درجات مادة $subject بنجاح.',
                  );
                }
              }

              final firstTotal = _examTermTotal(
                parseNumber(firstWorkController),
                parseNumber(firstExamController),
              );
              final secondTotal = _examTermTotal(
                parseNumber(secondWorkController),
                parseNumber(secondExamController),
              );
              final finalAverage = _examFinalAverage(firstTotal, secondTotal);
              final percent = maxMark <= 0
                  ? 0.0
                  : (finalAverage / maxMark) * 100;
                        ...
                        Container(
                          ...
                          child: Row(
                            children: <Widget>[
                              ...
                              Tooltip(
                                message: reviewedManually
                                    ? 'تم تدقيق المادة'
                                    : 'وضع علامة تدقيق المادة',
                                child: Switch.adaptive(
                                  value: reviewedManually,
                                  activeThumbColor: reviewAccent,
                                  onChanged: (value) => setDialogState(
                                    () => reviewedManually = value,
                                  ),
                                ),
                              ),
                            ],
  ...
  Widget _examSubjectCard(StudentRecord student, String subject) {
    ...
    final minimumMark = _examSubjectMinMark(subject, student);
    final firstTotal = _examTermTotal(entry.firstTermWork, entry.firstTermExam);
    final secondTotal = _examTermTotal(
      entry.secondTermWork,
      entry.secondTermExam,
    );
    final finalTotal = _examFinalAverage(firstTotal, secondTotal);

    Color termColor(bool entered, double score) {
      if (!entered) return const Color(0xFFC58A18);
      return score >= minimumMark
          ? const Color(0xFF1E7A43)
          : const Color(0xFFC44C5B);
    }

    Color termBackground(bool entered, double score) {
      if (!entered) return const Color(0xFFFFF4D6);
      return score >= minimumMark
    ...
    Widget statusChip(
      ...
      final passed = entered && score >= minMark;
      final color = !entered
          ? const Color(0xFFC58A18)
          : (passed ? const Color(0xFF1E7A43) : const Color(0xFFC44C5B));
      final bg = !entered
          ? const Color(0xFFFFF4D6)
          : (passed ? const Color(0xFFDFF3E5) : const Color(0xFFFDE8EC));
      return Container(
        ...
        child: Text(
          entered ? 'تم الإدخال - $label' : 'بانتظار الإدخال - $label',
          style: TextStyle(
            color: color,
            fontWeight: FontWeight.w900,
            fontSize: 11,
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(22),
          border: Border.all(
            color: reviewedManually ? const Color(0xFFC9D0FF) : AppPalette.line,
            width: reviewedManually ? 1.4 : 1,
          ),
          boxShadow: <BoxShadow>[
            BoxShadow(
              color: reviewedManually
                  ? reviewAccent.withValues(alpha: 0.08)
                  : const Color.fromRGBO(20, 40, 90, 0.05),
          ...
          children: <Widget>[
            Row(
              children: <Widget>[
                Container(
                  ...
                  child: Tooltip(
                    message: finalTotal >= minimumMark
                        ? 'ناجح في المادة'
                        : 'راسب في المادة',
                    child: Icon(
                      Icons.menu_book_outlined,
                      color: finalTotal >= minimumMark
                          ? const Color(0xFF1E7A43)
                          : const Color(0xFFC44C5B),
                    ),
                  ),
                      ...
                      Tooltip(
                        ...
                        child: Material(
                          ...
                          child: InkWell(
                            borderRadius: BorderRadius.circular(999),
                            onTap: () =>
                                _toggleExamSubjectReviewed(student, subject),
                            child: Padding(
            ...
            Wrap(
              ...
              children: <Widget>[
                ...
                statusChip('الفصل الأول', firstDone, firstTotal, minimumMark),
                statusChip(
                  'الفصل الثاني',
                  secondDone,
                  secondTotal,
            ...
            Container(
              ...
              padding: const EdgeInsets.all(12),
              decoration: BoxDecoration(
                color: termBackground(firstDone, firstTotal),
                borderRadius: BorderRadius.circular(16),
              ),
              child: Text(
                'محصلة الفصل الأول: ${_formatExamNumber(firstTotal)}',
                style: TextStyle(
                  color: termColor(firstDone, firstTotal),
                  fontWeight: FontWeight.w800,
                ),
              ),
            ),
            ...
            Container(
              ...
              padding: const EdgeInsets.all(12),
              decoration: BoxDecoration(
                color: termBackground(secondDone, secondTotal),
                borderRadius: BorderRadius.circular(16),
              ),
              child: Text(
                'محصلة الفصل الثاني: ${_formatExamNumber(secondTotal)}',
                style: TextStyle(
                  color: termColor(secondDone, secondTotal),
                  fontWeight: FontWeight.w800,
                ),
              ),
            ),
            ...
            _actionButton(
              ...
              AppPalette.goldDark,
              Colors.white,
              () => _showExamSubjectEditor(student, subject),
            ),
          ],
        ),
      ),
  ...
  Widget _examReportCardPortrait(StudentRecord student, List<String> subjects) {
    final totals = _examReportTotals(student, subjects);
    final rawResult = _finalResultLabel(student, subjects);
    final result = rawResult == 'غير مدخل' ? 'غير مكتمل' : rawResult;
    final year = student.schoolYear.isEmpty
        ? _currentAcademicYear()
        : student.schoolYear;
    final chairman = _secretaryNameController.text.trim().isEmpty
        ? 'رئيس مجلس الإدارة'
        : _secretaryNameController.text.trim();
    final director = _principalNameController.text.trim().isEmpty
        ? 'المدير'
        : _principalNameController.text.trim();
    final secretariat = _secretaryRoleNameController.text.trim().isEmpty
        ? 'أمانة السر والأشراف العام'
        : _secretaryRoleNameController.text.trim();
    final supervisor = _supervisorNameController.text.trim().isEmpty
        ? 'مشرف القسم'
        : _supervisorNameController.text.trim();
    ...
    Widget valueCell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: const Color(0xFF9DB8BA), width: 0.45),
        ),
        child: Text(
          text,
          textAlign: TextAlign.center,
    ...
    Widget subjectRow(String subject) {
      final entry = _examResultForStudentSubject(student, subject);
      final minMark = _examSubjectMinMark(subject, student);
      final maxMark = _examSubjectMaxMark(subject, student);
      final first = _examTermTotal(entry.firstTermWork, entry.firstTermExam);
      final second = _examTermTotal(entry.secondTermWork, entry.secondTermExam);
      final finalScore = _examFinalAverage(first, second);
      final finalColor = finalScore >= minMark
          ? const Color(0xFFE7F7EE)
          : const Color(0xFFFDE8EC);
      return Row(
        textDirection: TextDirection.rtl,
        children: <Widget>[
          valueCell(subject, flex: 3, bold: true),
          valueCell(_formatExamNumber(minMark), color: const Color(0xFFFFF7EA)),
          valueCell(_formatExamNumber(maxMark), color: const Color(0xFFEAF2FF)),
          valueCell(
            'أعمال: ${_formatExamNumber(entry.firstTermWork)}\nامتحان: ${_formatExamNumber(entry.firstTermExam)}\nمحصلة: ${_formatExamNumber(first)}',
            flex: 2,
            color: const Color(0xFFFFFBF2),
          ),
          valueCell(
            'أعمال: ${_formatExamNumber(entry.secondTermWork)}\nامتحان: ${_formatExamNumber(entry.secondTermExam)}\nمحصلة: ${_formatExamNumber(second)}',
            flex: 2,
            color: const Color(0xFFF2FBF5),
          ),
          valueCell(
            _formatExamNumber(finalScore),
            color: finalColor,
            bold: true,
          ),
        ],
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Wrap(
                ...
                runSpacing: 3,
                children: <Widget>[
                  _reportMetaSmall('الطالب', student.fullName),
                  _reportMetaSmall('الصف', _studentGradeDisplay(student)),
                  _reportMetaSmall('الشعبة', _studentSectionDisplay(student)),
                  _reportMetaSmall('الرقم', student.serial),
                ],
              ),
            ),
            ...
            Row(
              textDirection: TextDirection.rtl,
              children: <Widget>[
                headerCell('المادة', flex: 3),
                headerCell('الدنيا'),
                headerCell('العليا'),
                headerCell('الفصل الأول\nأعمال / امتحان / محصلة', flex: 2),
                headerCell('الفصل الثاني\nأعمال / امتحان / محصلة', flex: 2),
                headerCell('المحصلة'),
              ],
            ),
            ...
            Row(
              ...
              children: <Widget>[
                ...
                valueCell(
                  _formatExamNumber(totals['min']!),
                  bold: true,
                  color: const Color(0xFFFFF7EA),
                ),
                valueCell(
                  _formatExamNumber(totals['max']!),
                  bold: true,
                  color: const Color(0xFFEAF2FF),
                ),
                valueCell(
                  _formatExamNumber(totals['first']!),
                  flex: 2,
                  bold: true,
                  color: const Color(0xFFFFFBF2),
                ),
                valueCell(
                  _formatExamNumber(totals['second']!),
                  flex: 2,
                  bold: true,
                  color: const Color(0xFFF2FBF5),
                ),
                valueCell(
                  _formatExamNumber(totals['final']!),
                  bold: true,
                  color: result == 'ناجح'
                      ? const Color(0xFFDFF3E5)
                      : result == 'غير مكتمل'
  ...
  Widget _reportMetaSmall(String label, String value) {
    return Container(
  ...
  Widget _examReportCard(StudentRecord student, List<String> subjects) {
    ...
    final complexName = student.registryPlace.trim().isEmpty
        ? 'المجمع'
        : student.registryPlace.trim();
    final chairman = _secretaryNameController.text.trim().isEmpty
        ? 'رئيس مجلس الإدارة'
        : _secretaryNameController.text.trim();
    final director = _principalNameController.text.trim().isEmpty
    ...
    final supervisor = _supervisorNameController.text.trim().isEmpty
        ? 'مشرف القسم'
        : _supervisorNameController.text.trim();
    final rawResultLabel = _finalResultLabel(student, subjects);
    final resultLabel = rawResultLabel == 'غير مدخل' ? 'غير مكتمل' : rawResultLabel;
    final hasNoGrades = rawResultLabel == 'غير مدخل';
              ...
              child: LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  TableRow buildSubjectRow(
                    ...
                    final maxMark = _examSubjectMaxMark(subject, student);
                    final minMark = _examSubjectMinMark(subject, student);
                    final first = _examTermTotal(
                      e.firstTermWork,
                      e.firstTermExam,
                    );
                    final second = _examTermTotal(
                      e.secondTermWork,
                      e.secondTermExam,
                    );
                    ...
                    return TableRow(
                      ...
                      children: <Widget>[
                        cell(
                          _formatExamNumber(finalAvg),
                          bold: true,
                          cellColor: const Color(0xFFEAF2FF),
                          height: subjectH,
                        ),
                        cell(
                          _formatExamNumber(second),
                          bold: true,
                          cellColor: const Color(0xFFEDF8F1),
                          height: subjectH,
                        ),
                        cell(
                          _formatExamNumber(e.secondTermExam),
                          height: subjectH,
                        ),
                        cell(
                          _formatExamNumber(e.secondTermWork),
                          height: subjectH,
                        ),
                        cell(
                          _formatExamNumber(first),
                          bold: true,
                          cellColor: const Color(0xFFFFF7EA),
                          height: subjectH,
                        ),
                        cell(
                          _formatExamNumber(e.firstTermExam),
                          height: subjectH,
                        ),
                        cell(
                          _formatExamNumber(e.firstTermWork),
                          height: subjectH,
                        ),
                        cell(
                          _formatExamNumber(maxMark),
                          bold: true,
                          textColor: const Color(0xFF0F5C5A),
                          height: subjectH,
                        ),
                        cell(
                          _formatExamNumber(minMark),
                          textColor: const Color(0xFF5A6B6B),
                          height: subjectH,
                        ),
                  ...
                  final fillRows = <TableRow>[
                    for (var i = 0; i < subjects.length; i++)
                      buildSubjectRow(subjects[i], zebra: i.isOdd),
                  ];
                  ...
                  final fillTotals = TableRow(
                    ...
                    children: <Widget>[
                      cell(
                        _formatExamNumber(totals['final']!),
                        bold: true,
                        cellColor: const Color(0xFFE8F2FF),
                        height: totalsH,
                      ),
                      cell(
                        _formatExamNumber(totals['second']!),
                        bold: true,
                        cellColor: const Color(0xFFDFF3E5),
                        height: totalsH,
                      ),
                      cell(
                        '',
                      ...
                      cell(
                        _formatExamNumber(totals['first']!),
                        bold: true,
                        cellColor: const Color(0xFFF7E6BF),
                        height: totalsH,
                      ),
                      cell(
                        '',
                      ...
                      cell(
                        _formatExamNumber(totals['max']!),
                        bold: true,
                        cellColor: const Color(0xFFE7F3F2),
                        height: totalsH,
                      ),
                      cell(
                        _formatExamNumber(totals['min']!),
                      ...
                      cell(
                        'المجموع',
                        isHeader: true,
                        cellColor: const Color(0xFF1F6B69),
                        height: totalsH,
                      ),
                    ],
                  );
                          ...
                          TableRow(
                            ...
                            children: <Widget>[
                              ...
                              cell(
                                'المحصلة',
                                isHeader: true,
                                cellColor: const Color(0xFF2A7E7C),
                                height: headerH,
                              ),
                              cell(
                                'درجة\nالامتحان',
            ...
            Container(
              ...
              child: Row(
                children: <Widget>[
                  Expanded(
                    child: Text(
                      hasNoGrades ? 'النتيجة النهائية: غير مكتمل (لا توجد درجات)' : 'النتيجة النهائية: $resultLabel',
  ...
  Widget _examSignatureBlock(String label, String value) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.center,
      children: <Widget>[
        Text(
  ...
  Future<void> _showBulkExamReportsDialog() async {
    ...
    List<StudentRecord> filteredStudents() {
      return _studentsByGradeAndSection(
        grade: selectedGrade,
        section: selectedSection,
      );
    }
              ...
              content: SizedBox(
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: <Widget>[
                      const Text(
                        'حدد الصف والشعبة ثم اطبع كل الجلاءات المطابقة دفعة واحدة أو عاين/اطبع جلاء طالب محدد.',
                        style: TextStyle(color: AppPalette.muted, height: 1.8),
                      ),
                      const SizedBox(height: 14),
                      Row(
                      ...
                      Container(
                        ...
                        child: Text(
                          'عدد الجلاءات المطابقة: ${matches.length}',
                          style: const TextStyle(
                            color: AppPalette.deepNavySoft,
                            fontWeight: FontWeight.w800,
                          ),
                      ...
                      if (matches.isEmpty)
                        const Text(
                          'لا توجد جلاءات مطابقة للصف والشعبة المحددين.',
                          style: TextStyle(color: AppPalette.muted),
                        )
                      else
                        ...matches.map(
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      const SizedBox(height: 4),
                                      Text(
                                        '${_studentGradeDisplay(student)} • الشعبة ${_studentSectionDisplay(student)}',
                                        style: const TextStyle(
                                          color: AppPalette.muted,
                                        ),
                                      ),
  ...
  Widget _examActionChip(
    ...
    return Material(
      ...
      child: InkWell(
        onTap: onTap,
        borderRadius: BorderRadius.circular(14),
        hoverColor: AppPalette.gold.withValues(alpha: 0.14),
        child: Ink(
          padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 10),
          decoration: BoxDecoration(
            color: bg,
            ...
            boxShadow: const [
              BoxShadow(
                color: Color.fromRGBO(18, 58, 120, 0.06),
                blurRadius: 8,
                offset: Offset(0, 3),
              ),
            ],
  ...
  int _countEnteredFirstTermSubjects(StudentRecord student) {
    ...
    var n = 0;
    for (final subject in subjects) {
      if (_isFirstTermEntered(_examResultForStudentSubject(student, subject)))
        n++;
    }
    return n;
  }
  ...
  int _countEnteredSecondTermSubjects(StudentRecord student) {
    ...
    var n = 0;
    for (final subject in subjects) {
      if (_isSecondTermEntered(_examResultForStudentSubject(student, subject)))
        n++;
    }
    return n;
  }
                ...
                Wrap(
                  ...
                  children: <Widget>[
                    ...
                    _examActionChip(
                      ...
                      AppPalette.ivory,
                      AppPalette.goldDark,
                      () => _showManageExamSubjectsDialog(student),
                    ),
                    if (subjects.isNotEmpty)
                      _examActionChip(
                        ...
                        AppPalette.goldDark,
                        Colors.white,
                        () => _showExamSubjectEditor(student, subjects.first),
                      ),
                    _examActionChip(
                      'تدقيق الكل',
                      Icons.verified,
                      const Color(0xFF123A78),
                      Colors.white,
                      () => _markAllExamSubjectsReviewed(student),
                    ),
                    _examActionChip(
                    ...
                    _examActionChip(
                      _isExamReportExporting ? '...' : 'معاينة الجلاء',
                      Icons.visibility,
                      AppPalette.ivory,
                      AppPalette.goldDark,
                    ...
                    _examActionChip(
                      _isExamReportExporting ? '...' : 'طباعة الجلاء',
                      Icons.print,
                      AppPalette.leafGreen,
                      Colors.white,
              ...
              children: <Widget>[
                    ...
                    SizedBox(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            const Text(
                              'نموذج الجلاء / الحلقة أو المرحلة',
                              style: TextStyle(
                                color: Color(0xFF7E8D9D),
                                fontSize: 12,
                                fontWeight: FontWeight.w800,
                            ...
                            const SizedBox(height: 8),
                            DropdownButtonFormField<String>(
                              initialValue: _activeExamCycleForStudent(student),
                              isExpanded: true,
                              decoration: InputDecoration(
                                filled: true,
                                fillColor: const Color(0xFFFBFDFF),
                ...
                Wrap(
                  ...
                  children: <Widget>[
                    ...
                    _examSummaryTile(
                      'الفصل الأول (مُدخَل)',
                      '$firstEntered / ${subjects.length}',
                      AppPalette.goldDark,
                      Icons.looks_one_rounded,
                    ),
                    _examSummaryTile(
                      'الفصل الثاني (مُدخَل)',
                      '$secondEntered / ${subjects.length}',
                      AppPalette.leafGreen,
                ...
                _subSectionBanner(
                  'إدخال درجات المواد',
                  subtitle:
                      'عند اختيار الطالب يتبدل نموذج الجلاء تلقائيًا حسب صفه. كل مادة تُفتح في نافذة مستقلة مع منع تجاوز العلامة العظمى.',
                ),
                const SizedBox(height: 16),
                if (_showOnlyUnreviewedExamSubjects)
                  Container(
                ...
                if (visibleSubjects.isEmpty)
                  ...
                  Wrap(
                    spacing: 14,
                    runSpacing: 14,
                    children: visibleSubjects
                        .map((subject) => _examSubjectCard(student, subject))
                        .toList(),
                  ),
                const SizedBox(height: 18),
